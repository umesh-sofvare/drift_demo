...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    DriftCommunication$(_channel, serialize) {
      var t1 = new A.DriftCommunication(_channel, true, A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$._PendingRequest), A.StreamController_StreamController(null, null, true, type$.Request_2), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void));
    ...
    ServerImplementation$(connection, allowRemoteShutdown, closeExecutorWhenShutdown) {
      ...
      t1.ServerImplementation$3(connection, allowRemoteShutdown, true);
      return t1;
    },
    ...
    runCancellable(operation, $T) {
      var token = new A.CancellationToken(new A._SyncCompleter(new A._Future($.Zone__current, $T._eval$1("_Future<0>")), $T._eval$1("_SyncCompleter<0>")), A._setArrayType([], type$.JSArray_of_void_Function), $T._eval$1("CancellationToken<0>")),
        t1 = type$.nullable_Object;
      A.runZoned(new A.runCancellable_closure(token, operation, $T), A.LinkedHashMap_LinkedHashMap$_literal([B.Symbol_HZS, token], t1, t1), type$.void);
      return token;
    },
    checkIfCancelled() {
    ...
    PortToChannel_channel(_this) {
      ...
      A._EventStreamSubscription$(_this, "message", type$.nullable_void_Function_MessageEvent._as(new A.PortToChannel_channel_closure(false, controller)), false, type$.MessageEvent);
      ...
      new A._ControllerStream(t1, A._instanceType(t1)._eval$1("_ControllerStream<1>")).listen$2$onDone(B.MessagePort_methods.get$postMessage(_this), new A.PortToChannel_channel_closure0(false, _this));
      t1 = controller.__StreamChannelController__foreign_F;
      t1 === $ && A.throwLateFieldNI(_s8_);
      return t1;
    },
    PortToChannel_channel_closure: function PortToChannel_channel_closure(t0, t1) {
      this.explicitClose = t0;
      this.controller = t1;
    },
    PortToChannel_channel_closure0: function PortToChannel_channel_closure0(t0, t1) {
      this.explicitClose = t0;
      this._this = t1;
    },
    initSqlJs() {
    ...
    _replaceDartBigInts(dartList) {
      ...
      for (t2 = dartList.length, _i = 0; _i < dartList.length; dartList.length === t2 || (0, A.throwConcurrentModificationError)(dartList), ++_i) {
        arg = dartList[_i];
        if (arg instanceof A._BigIntImpl) {
          if (arg.compareTo$1(0, $.$get$_BigIntRangeCheck__bigIntMinValue64()) < 0 || arg.compareTo$1(0, $.$get$_BigIntRangeCheck__bigIntMaxValue64()) > 0)
            A.throwExpression(A.Exception_Exception("BigInt value exceeds the range of 64 bits"));
          t1.push(self.BigInt(arg.toString$0(0)));
        } else
          t1.push(arg);
      }
      return t1;
    ...
    _IndexedDbStorage: function _IndexedDbStorage(t0, t1, t2) {
      ...
      _.inWebWorker = t2;
      _.___IndexedDbStorage__database_A = $;
    },
    ...
    DriftWorkerMode: function DriftWorkerMode(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    _RunningDriftWorker: function _RunningDriftWorker(t0, t1) {
      var _ = this;
      _.isShared = t0;
      _.connectionFactory = t1;
      _._dedicatedWorker = _._knownMode = _._startedServer = null;
    },
    _RunningDriftWorker_start_closure: function _RunningDriftWorker_start_closure() {
    },
    _RunningDriftWorker__establishModeAndLaunchServer_closure: function _RunningDriftWorker__establishModeAndLaunchServer_closure(t0) {
      this.$this = t0;
    },
    _RunningDriftWorker__newConnection_remainingChannel: function _RunningDriftWorker__newConnection_remainingChannel(t0, t1) {
      this._box_0 = t0;
      this.originalChannel = t1;
    },
    _RunningDriftWorker__newConnection_remainingChannel_closure: function _RunningDriftWorker__newConnection_remainingChannel_closure(t0) {
      this._box_0 = t0;
    },
    _RunningDriftWorker__newConnection_closure: function _RunningDriftWorker__newConnection_closure(t0, t1, t2, t3) {
      var _ = this;
      _.$this = t0;
      _.originalChannel = t1;
      _.remainingChannel = t2;
      _.outgoingPort = t3;
    },
    ...
    main() {
      ...
      t1 = new A.main_closure();
      t2 = self;
      t2.toString;
      if (type$.SharedWorkerGlobalScope._is(t2))
        worker = new A._RunningDriftWorker(true, t1);
      else if (type$.DedicatedWorkerGlobalScope._is(t2))
        worker = new A._RunningDriftWorker(false, t1);
      else {
        A.throwExpression(A.StateError$("This worker is neither a shared nor a dedicated worker"));
        worker = null;
      }
      worker.start$0(0);
    },
  ...
  A._LinkedHashSet.prototype = {
    ...
    _remove$1(_, object) {
      ...
      if (rest == null)
        return false;
      hash = object.get$hashCode(0) & 1073741823;
      bucket = rest[hash];
  ...
  A.MapView.prototype = {
    ...
    get$values(_) {
      return this._collection$_map.get$values(0);
    },
    $isMap: 1
  };
  ...
  A._CancelOnErrorSubscriptionWrapper.prototype = {
    onError$1(_, handleError) {
      this.super$DelegatingStreamSubscription$onError(0, new A._CancelOnErrorSubscriptionWrapper_onError_closure(this, handleError));
    }
  };
  ...
  A.DriftCommunication.prototype = {
    DriftCommunication$3$debugLog$serialize(_channel, debugLog, serialize) {
      ...
      t1.get$stream(t1).listen$2$onDone(this.get$_communication$_handleMessage(), new A.DriftCommunication_closure(this));
    },
    newRequestId$0() {
      ...
      var $async$close$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if ($async$self._startedClosingLocally || ($async$self._closeCompleter.future._state & 30) !== 0) {
                // goto return
                $async$goto = 1;
                break;
              }
              $async$self._startedClosingLocally = true;
              $async$self._channel.get$sink().close$0(0);
              $async$goto = 3;
    ...
    _communication$_handleMessage$1(msg) {
    ...
    respondError$3(request, error, trace) {
      ...
      if (_this._startedClosingLocally || (_this._closeCompleter.future._state & 30) !== 0)
        return;
      t1 = request.id;
  ...
  A.DriftCommunication_closure.prototype = {
    call$0() {
      var t1, t2, t3, t4, t5;
      for (t1 = this.$this, t2 = t1._pendingRequests, t3 = t2.get$values(0), t4 = A._instanceType(t3), t4 = t4._eval$1("@<1>")._bind$1(t4._rest[1]), t3 = new A.MappedIterator(J.get$iterator$ax(t3.__internal$_iterable), t3._f, t4._eval$1("MappedIterator<1,2>")), t4 = t4._rest[1]; t3.moveNext$0();) {
  ...
  A.DriftCommunication_setRequestHandler_closure.prototype = {
    call$1(request) {
      return this.$call$body$DriftCommunication_setRequestHandler_closure(type$.Request_2._as(request));
    },
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 6:
              // after finally
              t1 = $async$self.$this;
              if (!(t1._startedClosingLocally || (t1._closeCompleter.future._state & 30) !== 0)) {
                t2 = response;
  ...
  A.DriftProtocol.prototype = {
    ...
    deserialize$1(message) {
      ...
      if (!type$.List_dynamic._is(message))
        throw A.wrapException(B.FormatException_6mY);
      ...
      throw A.wrapException(B.FormatException_6Jr);
    },
    encodePayload$1(payload) {
      ...
      if (payload instanceof A.NoArgsRequest)
        ...
        return A._setArrayType([13, payload.dialect._name], type$.JSArray_Object);
        ...
        if (t1.get$isEmpty(rows))
          ...
          for (t1 = t1.get$iterator(rows); t1.moveNext$0();)
            for (t2 = J.get$iterator$ax(J.get$values$x(t1.get$current(t1))); t2.moveNext$0();)
              result.push(this._encodeDbValue$1(t2.get$current(t2)));
          return result;
        }
    ...
    decodePayload$1(encoded) {
      ...
      switch (tag) {
        ...
        case 3:
          method = B.JSArray_methods.$index(B.List_pke, readInt.call$1(1));
          ...
          return new A.ExecuteQuery(method, sql, A.List_List$of(t1, true, A._instanceType(t1)._eval$1("ListIterable.E")), readNullableInt.call$1(4));
        case 4:
          t1.toString;
        ...
        case 5:
          return new A.RunTransactionAction(B.JSArray_methods.$index(B.List_kMT, readInt.call$1(1)), readNullableInt.call$1(2));
        case 6:
          return new A.EnsureOpen(readInt.call$1(1), readNullableInt.call$1(2));
        case 13:
          t1.toString;
          return new A.ServerInfo(A.EnumByName_byName(B.List_WDu, A._asString(J.$index$asx(t1, 1)), type$.SqlDialect));
        case 7:
          ...
          while (true) {
            ...
            if (kindIndex == null)
              ...
              if (kindIndex >>> 0 !== kindIndex || kindIndex >= 3)
                return A.ioore(B.List_8Gl, kindIndex);
              t3 = B.List_8Gl[kindIndex];
            }
        ...
        case 11:
          ...
          for (t1 = columns.__internal$_source, t3 = J.getInterceptor$asx(t1), t4 = columns.$ti._rest[1], t5 = 3 + columnCount, t6 = type$.nullable_Object, i = 0; i < rows; ++i) {
  ...
  A.ServerImplementation.prototype = {
    ...
    _closeRemainingConnections$0() {
      ...
      for (t1 = this._activeChannels, t1 = A._LinkedHashSetIterator$(t1, t1._collection$_modifications, t1.$ti._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
        ...
        (t3 == null ? t2._as(t3) : t3).close$0(0);
      }
    },
    _handleRequest$2(comms, request) {
      ...
      if (payload instanceof A.NoArgsRequest)
        switch (payload.index) {
          case 0:
            if (_this.allowRemoteShutdown) {
              _this._backlogUpdated.close$0(0);
              if (!_this._isShuttingDown) {
                _this._isShuttingDown = true;
                t1 = _this.connection.close$0(0);
                _this._done.complete$1(0, t1);
              }
            } else
              throw A.wrapException(A.StateError$("Remote shutdowns not allowed"));
            break;
        }
      else if (payload instanceof A.EnsureOpen)
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              ...
              if (!(executor instanceof A._TransactionExecutor))
  ...
  A.ServerImplementation_closure.prototype = {
    call$1(_) {
      ...
      t1._tableUpdateNotifications.close$0(0);
    },
    $signature: 44
  };
  ...
  A.runCancellable_closure.prototype = {
    call$0() {
      return this.token._resultCompleter.complete$1(0, A.Future_Future$sync(this.operation, this.T));
    },
    $signature: 0
  };
  ...
  A._BaseExecutor_runDelete_closure.prototype = {
    call$0() {
      ...
      t1._log$2(t2, t3);
      t1 = t1.get$impl();
      t4 = t1.___WebDelegate__db_A;
      t4 === $ && A.throwLateFieldNI("_db");
      t4.runWithArgs$2(t2, t3);
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ...
    beginTransaction$0() {
      ...
      return new A._StatementBasedTransactionExecutor(_this._engines$_delegate, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), _this, A._defaultSavepoint(ownDepth), A.delegates___defaultRelease$closure().call$1(ownDepth), A._defaultRollbackToSavepoint(ownDepth), _this._db, new A.Lock());
    },
    send$0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
    ...
    _afterCommitOrRollback$0() {
      ...
      _this._engines$_done.complete$0(0);
  ...
  A.DelegatedDatabase.prototype = {
    ...
    _runMigrations$1(user) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, currentVersion, oldVersion, t2, t3, t1, versionDelegate;
  ...
  A.DelegatedDatabase_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, e, s, _0_0, t2, t3, exception, t1, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = t1.delegate;
              t3 = A._Future$value(t2._isOpen, type$.bool);
              $async$goto = 3;
  ...
  A.PortToChannel_channel_closure.prototype = {
    call$1($event) {
      var message = new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as($event).data, true),
  ...
  A.PortToChannel_channel_closure0.prototype = {
    call$0() {
      this._this.close();
    },
    $signature: 0
  ...
  A.SqlJsDatabase.prototype = {
    runWithArgs$2(sql, args) {
      ...
      if (args.length === 0)
        ...
        t2.run$2(t1, sql, A._replaceDartBigInts(args));
    },
  ...
  A.PreparedStatement.prototype = {
    currentRow$1(useBigInt) {
      var t1 = J.$get$2$x(this._obj, null, null);
      return t1;
    }
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.___IndexedDbStorage__database_A;
              t1 === $ && A.throwLateFieldNI("_database");
              t1 = B.Database_methods.transactionStore$2(t1, "moor_databases", "readonly").objectStore("moor_databases");
              t1.toString;
            ...
            case 3:
              ...
              $async$goto = 4;
              return A._asyncAwait(new A._EventStream(reader, "load", false, type$._EventStream_ProgressEvent).get$first(0), $async$restore$0);
            case 4:
              // returning from await.
  ...
  A._WebDelegate.prototype = {
    ...
    runBatched$1(statements) {
      var t2, t3, t4, t5, _i, application,
        t1 = A._setArrayType([], type$.JSArray_PreparedStatement);
      for (t2 = statements.statements, t3 = t2.$ti, t2 = new A.ListIterator(t2, t2.get$length(0), t3._eval$1("ListIterator<ListBase.E>")), t3 = t3._eval$1("ListBase.E"); t2.moveNext$0();) {
        t4 = t2.__internal$_current;
        if (t4 == null)
          t4 = t3._as(t4);
        t5 = this.___WebDelegate__db_A;
        t5 === $ && A.throwLateFieldNI("_db");
        t1.push(new A.PreparedStatement(J.prepare$1$x(t5._obj, t4)));
      }
    ...
    runCustom$2(statement, args) {
      var t1 = this.___WebDelegate__db_A;
      t1 === $ && A.throwLateFieldNI("_db");
      t1.runWithArgs$2(statement, args);
      return A.Future_Future$value(null, type$.void);
    },
    runInsert$2(statement, args) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, $async$self = this, insertId, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 === $ && A.throwLateFieldNI("_db");
              t1.runWithArgs$2(statement, args);
              insertId = A._asInt($async$self.___WebDelegate__db_A._selectSingleRowAndColumn$1("SELECT last_insert_rowid();"));
              $async$goto = 3;
    ...
    runSelect$2(statement, args) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, stmt, t2, rows, columnNames, t1;
      var $async$runSelect$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.___WebDelegate__db_A;
              t1 === $ && A.throwLateFieldNI("_db");
              t1 = J.prepare$1$x(t1._obj, statement);
              stmt = new A.PreparedStatement(t1);
              t2 = J.getInterceptor$x(t1);
              t2.bind$1(t1, A._replaceDartBigInts(args));
              rows = A._setArrayType([], type$.JSArray_List_dynamic);
              for (columnNames = null; t2.step$0(t1);) {
                if (columnNames == null)
                  columnNames = t2.getColumnNames$0(t1);
                B.JSArray_methods.add$1(rows, stmt.currentRow$1(false));
              }
              if (columnNames == null)
                columnNames = A._setArrayType([], type$.JSArray_String);
              t2.free$0(t1);
              $async$goto = B.JSString_methods.contains$1(statement, "RETURNING") ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
              return A._asyncAwait($async$self._handlePotentialUpdate$0(), $async$runSelect$2);
            case 5:
              // returning from await.
            case 4:
              // join
              $async$returnValue = A.Future_Future$value(A.QueryResult$(columnNames, rows), type$.QueryResult);
              // goto return
              $async$goto = 1;
              break;
            case 1:
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait($async$self._storeDb$0(), $async$close$0);
            case 2:
              // returning from await.
              if ($async$self._isOpen) {
                t1 = $async$self.___WebDelegate__db_A;
                t1 === $ && A.throwLateFieldNI("_db");
                J.close$0$x(t1._obj);
              }
              $async$goto = 3;
              return A._asyncAwait($async$self.storage.close$0(0), $async$close$0);
            case 3:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      var $async$get$schemaVersion = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.delegate.___WebDelegate__db_A;
              t1 === $ && A.throwLateFieldNI("_db");
              t1 = A._asInt(t1._selectSingleRowAndColumn$1("PRAGMA user_version;"));
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
  ...
  A.DriftWorkerMode.prototype = {
    _enumToString$0() {
      return "DriftWorkerMode." + this._name;
    }
  };
  A._RunningDriftWorker.prototype = {
    start$0(_) {
      var t2,
      ...
      if (this.isShared) {
        t1 = self;
        t1.toString;
        A._EventStreamSubscription$(t1, "connect", type$.nullable_void_Function_MessageEvent._as(this.get$_newConnection()), false, type$.MessageEvent);
      } else {
        t2 = self;
        t2.toString;
        new A._MapStream(t1._eval$1("@(Stream.T)")._as(new A._RunningDriftWorker_start_closure()), new A._EventStream(t2, "message", false, t1), t1._eval$1("_MapStream<Stream.T,@>")).listen$1(this.get$_handleMessage());
      }
    },
    _establishModeAndLaunchServer$1(mode) {
      var server, _this = this;
      _this._knownMode = mode;
      server = _this._startedServer = A.ServerImplementation$(_this.connectionFactory.call$0(), mode === B.DriftWorkerMode_0, true);
      server._done.future.whenComplete$1(new A._RunningDriftWorker__establishModeAndLaunchServer_closure(_this));
      return server;
    },
    _newConnection$1($event) {
      var outgoingPort, originalChannel, t1 = {},
        t2 = type$.MessageEvent._as($event).ports;
      t2.toString;
      outgoingPort = J.get$first$ax(t2);
      originalChannel = A.PortToChannel_channel(outgoingPort);
      t1.subscription = null;
      t2 = originalChannel.__GuaranteeChannel__streamController_F;
      t2 === $ && A.throwLateFieldNI("_streamController");
      t1.subscription = new A._ControllerStream(t2, A._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(new A._RunningDriftWorker__newConnection_closure(this, originalChannel, new A._RunningDriftWorker__newConnection_remainingChannel(t1, originalChannel), outgoingPort));
    },
    _handleMessage$1(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, server;
      var $async$_handleMessage$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if (type$.MessagePort._is(message)) {
                server = $async$self._startedServer;
                if (server == null)
                  server = $async$self._establishModeAndLaunchServer$1(B.DriftWorkerMode_0);
                server.serve$1(A.PortToChannel_channel(message));
              } else
                throw A.wrapException(A.StateError$("Received unknown message " + A.S(message) + ", expected a port"));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$_handleMessage$1, $async$completer);
    }
  };
  A._RunningDriftWorker_start_closure.prototype = {
    call$1(e) {
      return new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as(e).data, true);
    },
    $signature: 57
  };
  A._RunningDriftWorker__establishModeAndLaunchServer_closure.prototype = {
    call$0() {
      if (this.$this.isShared) {
        var t1 = self;
        t1.toString;
        type$.SharedWorkerGlobalScope._as(t1).close();
      } else {
        t1 = self;
        t1.toString;
  ...
  A._RunningDriftWorker__newConnection_remainingChannel.prototype = {
    call$0() {
      var t1 = this.originalChannel,
        t2 = t1.$ti,
        t3 = t2._eval$1("Stream<1>(Stream<1>)")._as(new A._RunningDriftWorker__newConnection_remainingChannel_closure(this._box_0)).call$1(t1.get$stream(0)),
        t4 = new A.CloseGuaranteeChannel(t2._eval$1("CloseGuaranteeChannel<1>")),
        t5 = t2._eval$1("_CloseGuaranteeSink<1>");
      t4.set$__CloseGuaranteeChannel__sink_F(t5._as(new A._CloseGuaranteeSink(t4, t1.get$sink(), t5)));
      t2 = t2._eval$1("_CloseGuaranteeStream<1>");
      t2 = t2._as(new A._CloseGuaranteeStream(t3, t4, t2));
      t4.__CloseGuaranteeChannel__stream_F !== $ && A.throwLateFieldAI("_stream");
      t4.set$__CloseGuaranteeChannel__stream_F(t2);
      return t4;
    },
    $signature: 58
  };
  A._RunningDriftWorker__newConnection_remainingChannel_closure.prototype = {
    call$1(_) {
      var source = this._box_0.subscription;
      source.pause$0(0);
      source.onData$1(null);
      source.onError$1(0, null);
      source.onDone$1(null);
      return new A.SubscriptionStream(source, type$.SubscriptionStream_nullable_Object);
    },
    $signature: 59
  };
  A._RunningDriftWorker__newConnection_closure.prototype = {
    call$1(first) {
      var server, _this = this, _s5_ = "_sink",
        expectedMode = A.EnumByName_byName(B.List_bQo, A._asString(first), type$.DriftWorkerMode),
        t1 = _this.$this,
        t2 = t1._knownMode;
      if (t2 == null)
        switch (expectedMode.index) {
          case 0:
            t1 = _this.originalChannel.__GuaranteeChannel__sink_F;
            t1 === $ && A.throwLateFieldNI(_s5_);
            t1.add$1(0, false);
            t1.close$0(0);
            break;
          case 1:
            server = t1._establishModeAndLaunchServer$1(B.DriftWorkerMode_1);
            t1 = _this.originalChannel.__GuaranteeChannel__sink_F;
            t1 === $ && A.throwLateFieldNI(_s5_);
            t1.add$1(0, true);
            server.serve$1(_this.remainingChannel.call$0());
            break;
          case 2:
            t1._knownMode = B.DriftWorkerMode_2;
            t2 = new Worker(A.Uri_base().toString$0(0));
            t2.toString;
            t1._dedicatedWorker = t2;
            t1 = _this.outgoingPort;
            B.MessagePort_methods.postMessage$1(t1, true);
            B.Worker_methods.postMessage$2(t2, t1, A._setArrayType([t1], type$.JSArray_Object));
            t1 = _this.originalChannel.__GuaranteeChannel__sink_F;
            t1 === $ && A.throwLateFieldNI(_s5_);
            t1.close$0(0);
            break;
        }
      else if (t2 === expectedMode) {
        t2 = _this.outgoingPort;
        B.MessagePort_methods.postMessage$1(t2, true);
        switch (t1._knownMode.index) {
          case 0:
            throw A.wrapException(A.AssertionError$(null));
          case 1:
            t1 = t1._startedServer;
            t1.toString;
            t1.serve$1(_this.remainingChannel.call$0());
            break;
          case 2:
            t1 = t1._dedicatedWorker;
            t1.toString;
            B.Worker_methods.postMessage$2(t1, t2, A._setArrayType([t2], type$.JSArray_Object));
            t2 = _this.originalChannel.__GuaranteeChannel__sink_F;
  ...
  A.CloseGuaranteeChannel.prototype = {
    get$stream(_) {
      var t1 = this.__CloseGuaranteeChannel__stream_F;
      t1 === $ && A.throwLateFieldNI("_stream");
      return t1;
    },
    get$sink() {
      var t1 = this.__CloseGuaranteeChannel__sink_F;
      t1 === $ && A.throwLateFieldNI("_sink");
      return t1;
    },
  ...
  A.main_closure.prototype = {
    call$0() {
      return new A.WebDatabase(new A._WebDelegate(new A._IndexedDbStorage("worker", false, true), null, null, false), false, true, new A.Lock(), new A.Lock());
    },
    $signature: 70
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 72, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 79, 0);
    ...
    _static_1(A, "async___printToZone$closure", "_printToZone", 84);
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 85, 0);
    var _;
    _instance_0_u(_ = A._BroadcastSubscription.prototype, "get$_onPause", "_onPause$0", 0);
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 19, 0, 0);
    ...
    _instance_2_u(_, "get$_handleError", "_handleError$2", 90);
    _instance_0_u(_, "get$_handleDone", "_handleDone$0", 0);
    _static_1(A, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 24);
    _instance(A.MessagePort.prototype, "get$postMessage", 1, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 89, 0, 0);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 86);
    _instance_1_u(A.DriftCommunication.prototype, "get$_communication$_handleMessage", "_communication$_handleMessage$1", 5);
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 42);
    _static_1(A, "delegates___defaultSavepoint$closure", "_defaultSavepoint", 15);
    _static_1(A, "delegates___defaultRelease$closure", "_defaultRelease", 15);
    _static_1(A, "delegates___defaultRollbackToSavepoint$closure", "_defaultRollbackToSavepoint", 15);
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 88);
    _instance_1_u(_ = A._RunningDriftWorker.prototype, "get$_newConnection", "_newConnection$1", 30);
    _instance_1_u(_, "get$_handleMessage", "_handleMessage$1", 5);
    ...
    _static_1(A, "trace_Trace___parseVM_tearOff$closure", "Trace___parseVM_tearOff", 16);
    _static_1(A, "trace_Trace___parseFriendly_tearOff$closure", "Trace___parseFriendly_tearOff", 16);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Instantiation, A.Closure2Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._SyncBroadcastStreamController__sendData_closure, A._SyncBroadcastStreamController__sendDone_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.Stream_first_closure0, A.Stream_firstWhere_closure0, A.Stream_firstWhere__closure0, A._CustomZone_bindUnaryCallback_closure, A._CustomZone_bindUnaryCallbackGuarded_closure, A._RootZone_bindUnaryCallback_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._HashMap_values_closure, A._BigIntImpl_hashCode_finish, A._Uri__makePath_closure, A._createTables_setChars, A._createTables_setRange, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure, A._convertDartToNative_Value_closure, A._completeRequest_closure, A.Transaction_completed_closure, A.Transaction_completed_closure0, A.Transaction_completed_closure1, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.DriftCommunication_setRequestHandler_closure, A.DriftProtocol_decodePayload_readInt, A.DriftProtocol_decodePayload_readNullableInt, A.ServerImplementation_closure, A.ServerImplementation_serve_closure, A.ServerImplementation_serve_closure0, A.ServerImplementation__waitForTurn_closure, A.QueryResult_asMap_closure, A.Lock_synchronized_closure, A.PortToChannel_channel_closure, A._IndexedDbStorage_open_closure, A._RunningDriftWorker_start_closure, A._RunningDriftWorker__newConnection_remainingChannel_closure, A._RunningDriftWorker__newConnection_closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.WindowsStyle_absolutePathToUri_closure, A.Chain_Chain$parse_closure, A.Chain_toTrace_closure, A.Chain_toString_closure0, A.Chain_toString__closure0, A.Chain_toString_closure, A.Chain_toString__closure, A.Trace__parseVM_closure, A.Trace$parseV8_closure, A.Trace$parseJSCore_closure, A.Trace$parseFirefox_closure, A.Trace$parseFriendly_closure, A.Trace_toString_closure0, A.Trace_toString_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._TimerImpl$periodic_closure, A.Future_Future$delayed_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A.Stream_first_closure, A.Stream_firstWhere_closure, A.Stream_firstWhere__closure, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendError_sendError, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._cancelAndError_closure, A._cancelAndValue_closure, A._CustomZone_bindCallback_closure, A._CustomZone_bindCallbackGuarded_closure, A._rootHandleError_closure, A._RootZone_bindCallback_closure, A._RootZone_bindCallbackGuarded_closure, A._Utf8Decoder__decoder_closure, A._Utf8Decoder__decoderNonfatal_closure, A._CancelOnErrorSubscriptionWrapper_onError__closure, A.DriftCommunication_closure, A.ServerImplementation__handleRequest_closure, A.ServerImplementation__handleRequest_closure0, A.ServerImplementation__waitForTurn_idIsActive, A.runCancellable_closure, A._BaseExecutor__synchronized_closure, A._BaseExecutor_runSelect_closure, A._BaseExecutor_runDelete_closure, A._BaseExecutor_runInsert_closure, A._BaseExecutor_runCustom_closure, A._BaseExecutor_runBatched_closure, A._StatementBasedTransactionExecutor_ensureOpen_closure, A._StatementBasedTransactionExecutor_ensureOpen_closure0, A.DelegatedDatabase_ensureOpen_closure, A.DelegatedDatabase_close_closure, A.Lock_synchronized_callBlockAndComplete, A.PortToChannel_channel_closure0, A._RunningDriftWorker__establishModeAndLaunchServer_closure, A._RunningDriftWorker__newConnection_remainingChannel, A.Frame_Frame$parseVM_closure, A.Frame_Frame$parseV8_closure, A.Frame_Frame$_parseFirefoxEval_closure, A.Frame_Frame$parseFirefox_closure, A.Frame_Frame$parseFriendly_closure, A.Trace_Trace$from_closure, A.GuaranteeChannel_closure, A.GuaranteeChannel__closure, A.main_closure]);
    ...
    _inheritMany(A.Stream, [A._StreamImpl, A._ForwardingStream, A._EventStream, A.SubscriptionStream, A._CloseGuaranteeStream]);
    ...
    _inheritMany(A.WorkerGlobalScope, [A.DedicatedWorkerGlobalScope, A.SharedWorkerGlobalScope]);
    ...
    _inheritMany(A._Enum, [A.NoArgsRequest, A.StatementMethod, A.TransactionControl, A.UpdateKind, A.SqlDialect, A.DriftWorkerMode]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "bool(String)", "Null()", "~(@)", "~(Object?)", "Frame()", "Frame(String)", "@(@)", "~(Object,StackTrace)", "~(@,@)", "~(Event)", "Null(Event)", "Future<~>()", "~(~())", "String(int)", "Trace(String)", "Null(@)", "Null(@,StackTrace)", "~(Object[StackTrace?])", "bool()", "@()", "int(int,int)", "int(int)", "String(String)", "Future<Null>()", "~(Uint8List,String,int)", "~(String,String)", "bool(~)", "Future<int>()", "~(MessageEvent)", "int(Frame)", "String(Frame)", "Uint8List(@,@)", "~([Object?])", "Null(@,@)", "@(@,@)", "~(Object?,Object?)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<~>(Request)", "Object?(Object?)", "int?(int)", "Null(~)", "@(Request)", "Null(~())", "Future<@>()", "CancellationToken<@>?()", "Future<QueryResult>()", "@(String)", "_Future<@>(@)", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(Symbol0,@)", "~(VersionChangeEvent)", "@(MessageEvent)", "StreamChannel<Object?>()", "SubscriptionStream<Object?>(Stream<Object?>)", "0^(0^,0^)<num>", "String(String?)", "List<Frame>(Trace)", "int(Trace)", "~(String,int)", "String(Trace)", "~(String,int?)", "~(int,@)", "Frame(String,String)", "Trace()", "WebDatabase()", "Null(bool)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Object?(@)", "@(@,String)", "SqlJsModule(_SqlJs)", "~(@[List<Object>?])", "~(@,StackTrace)", "Null(Object,StackTrace)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      DriftWorkerMode: findType("DriftWorkerMode"),
...
;
    ...
    B.DriftWorkerMode_0 = new A.DriftWorkerMode(0, "dedicated");
    B.DriftWorkerMode_1 = new A.DriftWorkerMode(1, "shared");
    B.DriftWorkerMode_2 = new A.DriftWorkerMode(2, "dedicatedInShared");
    B.FormatException_6Jr = new A.FormatException("Unknown tag", null, null);
    B.FormatException_6mY = new A.FormatException("Cannot read message", null, null);
    ...
    B.List_8Gl = A._setArrayType(makeConstList([B.UpdateKind_0, B.UpdateKind_1, B.UpdateKind_2]), A.findType("JSArray<UpdateKind>"));
    ...
    B.List_WDu = A._setArrayType(makeConstList([B.SqlDialect_0_sqlite, B.SqlDialect_1_mysql, B.SqlDialect_2_postgres, B.SqlDialect_3_mariadb]), A.findType("JSArray<SqlDialect>"));
    ...
    B.List_bQo = A._setArrayType(makeConstList([B.DriftWorkerMode_0, B.DriftWorkerMode_1, B.DriftWorkerMode_2]), A.findType("JSArray<DriftWorkerMode>"));
    ...
    B.List_empty = A._setArrayType(makeConstList([]), A.findType("JSArray<Object?>"));
    ...
    B.List_kMT = A._setArrayType(makeConstList([B.TransactionControl_0, B.TransactionControl_1, B.TransactionControl_2]), A.findType("JSArray<TransactionControl>"));
    ...
    B.List_pke = A._setArrayType(makeConstList([B.StatementMethod_0, B.StatementMethod_1, B.StatementMethod_2, B.StatementMethod_3]), A.findType("JSArray<StatementMethod>"));
    ...
    B.List_empty2 = A._setArrayType(makeConstList([]), type$.JSArray_Map_of_String_and_nullable_Object);
    B.SelectResult_List_empty = new A.SelectResult(B.List_empty2);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_BigIntRangeCheck__bigIntMinValue64", "$get$_BigIntRangeCheck__bigIntMinValue64", () => A.BigInt_parse("-9223372036854775808"));
    _lazyFinal($, "_BigIntRangeCheck__bigIntMaxValue64", "$get$_BigIntRangeCheck__bigIntMaxValue64", () => A.BigInt_parse("9223372036854775807"));
